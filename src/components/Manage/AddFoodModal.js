                            ...
                            <Col sm={12}>
                                <Form onSubmit={this.handleSubmit}>
                                    <Form.Group controlId="food_type">
                                        ...
                                        <Form.Control type="text" name="food_type" placeholder="Food Type" required autoFocus />
                                        
                                    </Form.Group>

                                    <Form.Group controlId="food_name">
                                        <Form.Label>Food Name</Form.Label>
                                        <Form.Control type="text" name="food_name" placeholder="Food Name" required/>
                                    </Form.Group>

                                    <Form.Group controlId="food_price">
                                        <Form.Label>Price</Form.Label>
                                        <Form.Control type="text" name="food_price" placeholder="Price" required />
