                        ...
                        <Row>
                            <Col sm={12}>
                                ...
                                <Form.Group controlId="food_type">
                                        ...
                                        <Form.Control type="text" name="food_type" required placeholder="Food Type" autoFocus/>
                                    </Form.Group>
                                    <Form.Group controlId="food_name">
                                        <Form.Label>Food Name</Form.Label>
                                        <Form.Control type="text" name="food_name" required placeholder="Food Name" />
                                    </Form.Group>
                                    <Form.Group controlId="food_price">
                                        <Form.Label>Food Price</Form.Label>
                                        <Form.Control type="text" name="food_price" required placeholder="Food Price" />
                                    </Form.Group>
